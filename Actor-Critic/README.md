...
Their CartPole env was used for this project (CartPole-v1).
...
* [Gymnasium](https://gymnasium.farama.org/) (maintained successor of OpenAI Gym)
...
2. Install Pytorch and Gymnasium
   ```sh
   $ pip3 install torch
   $ pip3 install gymnasium
   # For LunarLander you may also need Box2D support:
   # pip3 install "gymnasium[box2d]"
   ```
 
3. Run scripts
   ```sh
   $ python3 scripts/cart-pole-baseline.py
   $ python3 scripts/cart-pole-a2c.py
   $ python3 scripts/lunar-lander-baseline.py
   $ python3 scripts/lunar-lander-a2c.py
   ```
